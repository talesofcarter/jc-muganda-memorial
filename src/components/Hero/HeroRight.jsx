...
const HeroRight = () => {
  return (
    <section className="flex flex-col items-center justify-center w-full md:w-1/2 p-6 md:p-12 text-center bg-gradient-to-b from-gray-900 to-black text-white">
      ...
      <p className="text-2xl md:text-3xl lg:text-4xl font-light italic mt-6 animate-fade-in-up">
